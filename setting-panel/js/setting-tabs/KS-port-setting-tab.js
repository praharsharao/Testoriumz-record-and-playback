...
class KSPortSettingTab { //Implements ISettingTab
  ...
  getContent() {
    return `
        ...
        <p>Allow users to change the default port used by <a target="_blank" href="https://reporting.linkfields.com/ui/#login">Testoriumz Studio</a> to communicate with the active Chrome browser (support for Firefox is coming soon). The desktop application preference must be configured accordingly as the screenshot below.</p>
        <form>
        ...
        <p><a target="_blank" href="https://reporting.linkfields.com/ui/#login">Testoriumz Studio</a> and Testoriumz Recorder are completely free. For more information contact us at <a target="_blank" href="mailto:info@testoriumz.com">info@testoriumz.com</a>.</p>

        <h1><a href="https://reporting.linkfields.com/ui/#login" target="_blank">Acknowledgments</a></h1>
        </div>`;
  }
