import { parseSuiteName } from "../helper-service/parser.js";
import { saveDataFiles } from "../data-file-service/data-file-services.js";
...
function addSampleCSVData() {
  ...
  window.dataFiles = JSON.parse(sampleCSVData);
  saveDataFiles();
}
