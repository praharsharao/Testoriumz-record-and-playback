...
},
{
    ...
    <tbody>
    <tr><td>open</td><td>https://reporting.linkfields.com/ui/#login<datalist><option>https://reporting.linkfields.com/ui/#login</option></datalist></td><td></td></tr>
    ...
    <tr><td>open</td><td>https://reporting.linkfields.com/ui/#login<datalist><option>link=Checkout</option><option>xpath=//a[contains(text(),'Checkout')]</option><option>xpath=//div[@id='primary-menu']/ul/li[2]/a</option><option>xpath=(.//*[normalize-space(text()) and normalize-space(.)='Cart'])[1]/following::a[1]</option><option>xpath=(.//*[normalize-space(text()) and normalize-space(.)='Menu'])[1]/following::a[2]</option><option>xpath=(.//*[normalize-space(text()) and normalize-space(.)='My account'])[1]/preceding::a[1]</option><option>xpath=(.//*[normalize-space(text()) and normalize-space(.)='Sample Page'])[1]/preceding::a[2]</option><option>xpath=//*/text()[normalize-space(.)='Checkout']/parent::*</option><option>xpath=//a[contains(@href, 'https://reporting.linkfields.com/ui/#login')]</option><option>xpath=//li[2]/a</option><option>css=li.page_item.page-item-9.focus > a</option><option>https://reporting.linkfields.com/ui/#login</option></datalist></td><td></td></tr>
...
},
{
    ...
    <tbody>
    <tr><td>open</td><td>https://reporting.linkfields.com/ui/#login<datalist></datalist></td><td></td></tr>
