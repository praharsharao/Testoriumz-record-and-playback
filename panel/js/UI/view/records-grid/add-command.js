...
import { appendAddVariableButton, appendValueContextMenu } from "./global-profile-context-menu.js";
...
function addCommand(command_name, command_target_array, command_value, auto, insertCommand) {
    ...
    if (selected_ID) {
        ...
        if (auto) {
            attachEvent(selected_ID + 1, selected_ID + 1);
    ...
    for (var k = 1; k < 4; ++k) {
        ...
        // if (k === 3 && string !== "") {
        //     appendValueContextMenu(new_record.id);
        //     appendAddVariableButton(new_record.id);
        // }
    }
