...
import {
    ...
    appendValueContextMenu, removeAddVariableButton,
    removeValueContextMenu
} from "../../view/records-grid/global-profile-context-menu.js";
...
//                     tdElement.innerText = event.target.value;
...
// $("#command-value").on("input", async function(event) {
//     var temp = getSelectedRecord();
//     if (temp) {
...
//             appendValueContextMenu(temp);
//             appendAddVariableButton(temp);
//         } else {
//             removeValueContextMenu(temp);
//             removeAddVariableButton(temp);
//         }
