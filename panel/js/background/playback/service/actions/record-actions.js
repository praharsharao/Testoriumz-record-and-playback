...
const recordAction = async () => {
  ...
  //   let result = await checkLoginOrSignupUserForCreateTestCase();
  //   if (!result) {
  //     return;
  //   }
  // }
  ...
  if (isRecording) {
    doRecord();
    trackingRecord();
    $('#playback').fadeOut("slow");
    $('#playSuite').fadeOut("slow");
    $('#playSuites').fadeOut("slow");
    $('#pause').fadeOut("slow");
  } else {
    $('#playback').fadeIn("slow");
    $('#playSuite').fadeIn("slow");
    $('#playSuites').fadeIn("slow");
    $('#pause').fadeIn("slow");
