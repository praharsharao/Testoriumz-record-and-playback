...
import { parseData, saveDataFiles } from "../../../../../UI/services/data-file-service/data-file-services.js";
...
const executeWriteToCSV = (location, value) => {
  ...
  if (window.dataFiles[fileName] !== undefined) {
