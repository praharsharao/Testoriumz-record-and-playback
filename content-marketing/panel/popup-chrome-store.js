...
function popupRateUsDialog() {
  ...
  let dialogHTML = `
    ...
    <span>
            Are you using Testoriumz Recorder to make your life more simple? If yes, take a second to leave your <b>feedback</b> on ${bowser.name} store.
    </span>
    </br>
    <style>
        .rateUsBtn{
...
async function shouldDisplayRateWebStorePopup(testCaseExecutionNum) {
  const threshold = 20;
  return testCaseExecutionNum / threshold === 1;
}
