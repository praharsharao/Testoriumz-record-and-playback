...
import * as sampleProjectService from "../../../../../../panel/js/UI/services/sample-project-service/sample-project-service.js";
import { unmarshall } from "../../../../../../panel/js/UI/services/helper-service/parser";
import { addTestSuite } from "../../../../../../panel/js/UI/services/data-service/test-suite-service";
import { saveDataFiles } from "../../../../../../panel/js/UI/services/data-file-service/data-file-services";
...
<table cellpadding="1" cellspacing="1" border="1">
  <thead>
  <tr><td rowspan="1" colspan="3" data-tags="">Capture screenshots</td></tr>
  </thead>
  <tbody>
  ...
  <tr><td>captureEntirePageScreenshot</td><td>after-adding-comment<datalist><option>after-adding-comment</option></datalist></td><td></td>
      ...
      const sampleTestSuites = sampleProjectService.addSampleData(sampleData, [0]);
    ...
    it("add normal sample data with data", function () {
      const sampleData = [{
        ...
        testSuite: "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
          ...
          "<table cellpadding=\"1\" cellspacing=\"1\" border=\"1\">\n" +
          "<thead>\n" +
          "<tr><td rowspan=\"1\" colspan=\"3\" data-tags=\"\">storeCSV sample</td></tr>\n" +
          "</thead>\n" +
          "<tbody>\n" +
      ...
      spyOn(sampleProjectService, "addSampleData").and.callFake(function(sampleData, selectedSampleIndexes){
        ...
        for (const sample of samples) {
          ...
          //load data files
          if (sample.data) {
            window.dataFiles = Object.assign(window.dataFiles, sample.data);
          }
        }
    ...
    it("pass null or undefined sampleData", function () {
      expect(function () {
        const { sampleTestSuites, sideex_ids } = sampleProjectService.addSampleData(null, [0, 1, 2, 3]);
      }).toThrow("Null or undefined sampleData");
      expect(function () {
        const { sampleTestSuites, sideex_ids } = sampleProjectService.addSampleData(undefined, [0, 1, 2, 3]);
      }).toThrow("Null or undefined sampleData");
    });

    it("pass null or undefined selectedSampleIndexes", function () {
      expect(function () {
        const { sampleTestSuites, sideex_ids } = sampleProjectService.addSampleData(sampleProjectService.sampleData, null);
      }).toThrow("Null or undefined selectedSampleIndexes");
      expect(function () {
        const { sampleTestSuites, sideex_ids } = sampleProjectService.addSampleData(sampleProjectService.sampleData,);
      }).toThrow("Null or undefined selectedSampleIndexes");
    });

    it("pass wrong not existed index in selectedSampleIndexes", function () {
      const sampleTestSuites = sampleProjectService.addSampleData(sampleProjectService.sampleData, [-1, 100]);
